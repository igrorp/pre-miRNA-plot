...
<blockquote>
<p>If you are not familiar with command line, each one of this lines above has to run separetly. Copy the command in each line, run it and wait to see if the process was successfull.</p>
</blockquote>
